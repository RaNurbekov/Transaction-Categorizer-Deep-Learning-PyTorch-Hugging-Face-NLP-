...
def tokenize_function(examples):
    #padding and trunction обрезают или удлиняют чеки до одинакокой длины(16 токенов)
...
#Разбиваем на Train and Test (80/20)
...
#Сохраняем и саму модельб и токенизатор
